    <form action="{{ url('/customer/ajax') }}" method="POST" id="form-tambah" enctype="multipart/form-data">
        @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input  type="text" name="wa" id="wa" class="form-control" placeholder="ex: 628123456789"
                            required>
