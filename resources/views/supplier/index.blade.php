        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="row">
                    <div class="dropdown mr-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="importExportDropdown">
                            <button class="dropdown-item d-flex align-items-center"
                                onclick="modalAction('{{ url('/supplier/import') }}')">
                                <i class="fa fa-upload mr-2 text-primary"></i> Import Data
                            </button>
                            <a class="dropdown-item d-flex align-items-center" href="{{ url('/supplier/export_excel') }}">
                                <i class="fa fa-file-excel mr-2 text-success"></i> Export to Excel
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="{{ url('/supplier/export_pdf') }}"
                                target="_blank">
                    ...
                    <button onclick="modalAction('{{ url('/supplier/create_ajax') }}')" class="btn btn-primary mr-2">Tambah
                        Data</button>
                </div>
            </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            let html = `<a href="https://wa.me/${data}" target="_blank" class="btn btn-success">
